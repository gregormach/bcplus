...
from electroncashplus.util import format_satoshis, format_satoshis_plain
...
class ElectrumWindow(App):
    ...
    def __init__(self, **kwargs):
        ...
        title = _('Electron-Cash-Plus App')
    ...
    def on_qr(self, data):
        from electroncashplus.bitcoin import base_decode
        data = data.strip()
        ...
        from electroncashplus.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electroncashplus.util import format_time
    ...
    def init_ui(self):
        ...
        self.icon = "icons/electron-cash-plus.png"
