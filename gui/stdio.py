...
from electroncashplus.util import format_satoshis, set_verbosity
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electron-cash-plus create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electron-cash-plus setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electron-cash-plus setconfig' to change your settings")
        return True
